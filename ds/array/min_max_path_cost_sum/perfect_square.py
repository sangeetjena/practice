...
Note: same as coin change problem. only difference is, allowd number are perfect squre number  i.e : 2*2=4, 3*3=9 etc.
"""
...
class Solution:
    def numSquares(self, n: int) -> int:
        # this simular to the integer breaking problem
